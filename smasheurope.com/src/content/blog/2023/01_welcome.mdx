...
categories: { news }
draft: false
desc: "It took a while but we're honored to finally launch the revamped version of SmashEurope. Read on to learn more."
tags: { news, welcome } 
slug: welcome
---

![SmashEurope Logo](/{frontmatter.image} "SmashEurope Logo") 
# {frontmatter.title}
